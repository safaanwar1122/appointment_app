...
final   List<AvailableTime> _availableTimes = [
    ...
    AvailableTime(time: "9:30 AM", isSchedule: false, isFutureSchedule: true, isCancel: true),
    AvailableTime(time: "10:00 AM", isSchedule: true, isFutureSchedule: false, isCancel: false),
    ...
    AvailableTime(time: "11:30 AM", isSchedule: false, isFutureSchedule: false, isCancel: true),
    AvailableTime(time: "12:00 PM", isSchedule: false, isFutureSchedule: false, isCancel: true),
    AvailableTime(time: "12:30 PM", isSchedule: false, isFutureSchedule: true, isCancel: true),
    AvailableTime(time: "1:00 PM", isSchedule: false, isFutureSchedule: false, isCancel: true),
    AvailableTime(time: "1:30 PM", isSchedule: false, isFutureSchedule: false, isCancel: true),
    AvailableTime(time: "2:00 PM", isSchedule: false, isFutureSchedule: true, isCancel: false),
    ...
    AvailableTime(time: "4:00 PM", isSchedule: false, isFutureSchedule: false, isCancel: true),
